...
// ---- CURL (opcional, solo verificación de extensión) ----
if (function_exists('curl_init')) {
    $result['checks'][] = "✅ Extensión CURL disponible (sin dependencias externas)";
} else {
    $result['checks'][] = "❌ Extensión CURL NO disponible";
    $result['success'] = false;
}
